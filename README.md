...
### 4. Giai đoạn liên kết (Linker)
  ...
  -> Để chạy file code C trên Terminal dùng lệnh `gcc -o filename filename.c` hoặc `gcc -o filename.exe filename.c` để tạo ra file thực thi, sau đó dùng lệnh `./filename` để chạy file thực thi
